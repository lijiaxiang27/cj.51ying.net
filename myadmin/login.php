...
<div class="login-wrapper">
    <div class="login-container">
        ...
        <form action="login.do.php" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <input class="form-control" name="userpwd" placeholder="密码" type="password"><input type="submit"
                                                                                                   value="&#xf054;">
            </div>
        ...
        <p class="signup" style="color:#999">
            ...
            require 'db.php';
             ?>
            <a class="login-link" href="<?php echo $conf['copyrightlink'];?>" target="_blank">Powered by:<?php echo $conf['copyright'];?></a>
        </p>
    </div>
</div>
<!-- End Login Screen -->
