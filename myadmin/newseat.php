    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="widget-container fluid-height clearfix">
                <div class="heading">
                    <i class="icon-table"></i>座位列表 <?php if (version_compare(PHP_VERSION, '5.3.0') >0) { ?> <a href="exportqd.php" target="_blank" style="float:right;" data-step="1" data-intro="点击此处导出签到列表EXCEL"><i class="icon-download"></i>导出excel</a><?php } ?>
               ...
               <!--  <div class="alert alert-warning">
                ...
                <div class="widget-content padded clearfix form-horizontal">
                    ...
                    <div class="form-group col-md-5 pull-right">
                        ...
                        <div class="col-md-8">
                            <form action="newseat.php" method="get" novalidate="novalidate">
                    ...
                    <table class="table table-striped" >
                        ...
                        if ($_SERVER['REQUEST_METHOD']=="POST"){
                            ...
                            $flag_m->update($where, ['user_phone'=>$info['user_phone'],'status'=>1]);
                        }
                        ...
                        if($searchtext!=''){
                            $search_sql='  user_phone like \'%'.$searchtext.'%\'  ';
                        }
                        else {
                            $search_sql = ' 1 = 1 ';
                        }
...
//                            $q = emoji_unified_to_html(emoji_softbank_to_unified($q));
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo  $q['user_phone']; ?>
                                </td>

                                <td class="hidden-xs">
                                    <?php echo  $q['seates_area'].':'.$q['seates_code'] ?>
                                </td>

                                <td class="hidden-xs">
                                    <?php echo  $q['status'] == 1 ? '<span style="color: #F00303">已签到</span>' : '未签到'; ?>
                                </td>
                                <td class="hidden-xs">
...
//                        }
                    ...
                    echo pager($page,$pagesize,$querycount,'newseat.php',$_GET);
                    ?>
                </div>
            </div>
