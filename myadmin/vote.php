            ...
            <div class="modal-body">
                ...
                <form method="post" action="shenhe.do.php?do=voteconfig" enctype="multipart/form-data">
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input class="form-control" name="votetiltle" value="<?php echo  $xuanzezu['votetitle']; ?>" type="text">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input class="form-control" name="voterefresht" value="<?php echo  $xuanzezu['votefresht']; ?>" type="text">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            ...
                            当前每人可投<?php echo  $xuanzezu['votecannum']; ?>票
                        </div>
                    </div>
...
//                    $numdel = mysql_num_rows($querytp);
                    $numdel= count($votes);
                    ?>
                    <i class="icon-table"></i>投票管理<a class="btn btn-sm btn-primary-outline pull-right"
                                                     href="shenhe.do.php?do=zengjian&cid=1&numdel=<?php echo  $numdel; ?>"><i
                            class="icon-plus"></i>增加一行</a><a class="btn btn-sm btn-primary-outline pull-right"
                                                             data-toggle="modal" href="#votemodal"><i
                            class="icon-gear"></i>投票参数</a><a class="btn btn-sm btn-primary-outline pull-right"
                                                             href="shenhe.do.php?do=chongzhi&cid=<?php echo  $numdel; ?>"><i
                            class="icon-ban-circle"></i>投票清零</a>
                </div>
...
//                        while ($q = mysql_fetch_row($querytp)) {
                            ...
                            <tr name="<?php echo  $q['id']; ?>">
                                ...
                                <td class="actions">
                                    <a class="edit-row" href="javascript:void(0)"><i class="icon-pencil"></i></a>
                                    <a class="dete-row" href=""><i
...
//     $.ajax({
//         'url':"shenhe.do.php?do=zengjian&cid=2&numdel=<?php echo  $q['id']; ?>",
//     })
// }
</script>
</body>
