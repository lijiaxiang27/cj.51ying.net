    ...
    <div class="fl-inner fl-bg">
        <div class="inner-cont clearfix">
            <div class="ui top green attached segment vote-top">
                <h1 class="vote-title">{$config['votetitle']}</h1>
            ...
            <div class="ui bottom attached segment">
                ...
                <div class="ui bottom right attached label vote-right"><a class="ui black circular label"
                                                                          id="closevote">×</a></div>
...
<script>{literal}
    var votefresht ={/literal}{$config['votefresht']}{literal};
    var voteshowway ={/literal}{$config['voteshowway']}{literal};
    {/literal}
</script>
