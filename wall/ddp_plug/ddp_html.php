        ...
        <div class="inner-cont clearfix">
            ...
            <div class="lottery-box">
                <div class="box-ltop">
                    ...
                    <p class="lott-w"><span>参加配对人数</span><em class="join-num" id="ddp_userCount"><img
                                src="ddp_plug/images/loading.gif"/></em></p>
                </div>
                <div class="bubble">
                ...
                <div class="rock-box clearfix" id="ddp_box">
                    <div class="pair-one">
                        <span class="rock-head"><img id="ddp_userAvatar" src="ddp_plug/images/pair-default.png"
                                                     width="178" height="178" alt=""></span>
                        <span class="rock-name" id="ddp_userName">……</span>
                        <input type="hidden" id="mid" value="">
                    </div>
                    <div class="pair-one">
                        <span class="rock-head"><img id="ddp_toUserAvatar" src="ddp_plug/images/pair-default.png"
                                                     width="178" height="178" alt=""></span>
